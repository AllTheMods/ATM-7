onEvent('recipes', (e) => {
  ...
  //Tier 1 Crops
  tier(
    ['inferium', 'air', 'earth', 'fire', 'water', 'dirt', 'wood', 'ice', 'stone', 'deepslate'],
    1000,
    '#misctags:farmland/tier1',
    2
  );
  //Tier 2 Crops
  tier(
  ...
  //Tier 4 Crops
  tier(
    ['blaze', 'end', 'enderman', 'experience', 'ghast', 'gold', 'lapis_lazuli', 'nickel', 'osmium'],
    3250,
  ...
  //Tier 5 Crops
  tier(
    ['diamond', 'emerald', 'netherite', 'wither_skeleton', 'platinum', 'uranium'],
    4000,
