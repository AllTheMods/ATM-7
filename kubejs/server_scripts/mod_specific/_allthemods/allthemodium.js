onEvent("recipes", (e) => {
  function upgrade(material, previous, next) {
    ...
    e.recipes.allthemodium
      ...
      .id(
        `kubejs:allthemodium/${previous.replace(`:`, `_`)}_chestplate_upgrade`
      );
