...
onEvent('recipes', (e) => {
  ...
  function ieUnifyOres(input, type) {
    ...
    if (type === 'ore') {
      ...
      e.shapeless(crusherOutput, [inputIngredient, '#alltheores:ore_hammers']).id(
        `kubejs:hammercrushing/${input}_ore`
      );
    }
  ...
  function blastingUnifyOres(ore) {
    ...
    e.blasting(`${oreOverride[ore] ?? 'alltheores'}:${ore}_ingot`, `#forge:dusts/${ore}`)
      .xp(0.2)
    ...
    e.smelting(`${oreOverride[ore] ?? 'alltheores'}:${ore}_ingot`, `#forge:dusts/${ore}`)
      .xp(0.2)
    ...
    e.blasting(`${oreOverride[ore] ?? 'alltheores'}:${ore}_ingot`, `#forge:ores/${ore}`)
      .xp(1.0)
    ...
    e.smelting(`${oreOverride[ore] ?? 'alltheores'}:${ore}_ingot`, `#forge:ores/${ore}`)
      .xp(1.0)
