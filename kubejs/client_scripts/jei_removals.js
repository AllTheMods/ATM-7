onEvent("jei.hide.items", (e) => {
  ...
  colors.forEach((color) => {
    refined.forEach((machine) =>
      e.hide([`refinedstorage:${color}_${machine}`])
    );
  });
  ...
  hideMetal("immersiveengineering", "aluminum", [
    "ingot",
    "ore",
    "dust",
    "nugget",
  ...
  hideMetal("immersiveengineering", "uranium", [
    "ingot",
    "ore",
    "dust",
    "nugget",
  ...
  hideMetal("immersiveengineering", "steel", [
    "ingot",
    "dust",
    "nugget",
    "storage",
  ...
  hideMetal("immersiveengineering", "electrum", [
    "ingot",
    "dust",
    "nugget",
    "storage",
  ...
  hideMetal("immersiveengineering", "constantan", [
    "ingot",
    "dust",
    "nugget",
    "storage",
  ...
  hideStuff("alltheores", "dirty_dust", [
    "osmium",
    "copper",
    "tin",
    "lead",
  ...
  hideStuff("appliedenergistics2", "dust", [
    "nether_quartz",
    "ender",
    "iron",
    "gold",
